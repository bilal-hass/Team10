...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("REPEAT USER PASSWORD");
    ...
    private void LoginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoginButtonMouseClicked
        ...
        String pwEntry = jTextField1.getText();
        String query = "SELECT COUNT(*) FROM StaffAccount WHERE id = " + UserController.currentUser.getId().toString() + " AND Password = '" + pwEntry + "';";
