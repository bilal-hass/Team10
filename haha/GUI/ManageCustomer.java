...
public class ManageCustomer extends javax.swing.JFrame {
    ...
    private void SelectedCustomer(CustomerAccount c) {
        SelectedCustomer = c;
        CusotmerLabel.setText("CUSTOMER: " + c.getName());
        jTextField1.setText(c.getName());
        jTextField2.setText(c.getEmail());
        jTextField3.setText(c.getAddress());
        jTextField4.setText(c.getPhoneNumber());
        ValuedDropDown.setSelectedIndex( (c.getValued() ? 0 : 1) );
        if (c.hasDiscountPlan()) {
            DiscountLabel.setText("DISCOUNT PLAN: " + c.getDiscountPlan().getName());
        }
    }

    private Discount SelectedDiscount;
    private void SelectedDiscount(Discount d) {
        SelectedDiscount = d;
        DiscountLabel.setText("DISCOUNT PLAN: " + d.getName());
    }
    ...
    private void initComponents() {
        ...
        CusotmerLabel = new javax.swing.JLabel();
        ...
        ValuedDropDown = new javax.swing.JComboBox();

        ValuedDropDown.setModel(
        ...
        CusotmerLabel.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        CusotmerLabel.setText("CUSTOMER: NONE SELECTED");

        DiscountButton.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        DiscountButton.setText("SELECT DISCOUNT");
        DiscountButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DiscountButtonMouseClicked(evt);
            }
        });
        ...
        jLabel7.setText("VALUED: ");

        DiscountLabel.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        DiscountLabel.setText("DISCOUNT PLAN: NONE SELECTED");
    ...
    private void ConfirmButtonMouseCLicked(java.awt.event.MouseEvent evt) {
        ...
        if (SelectedCustomer == null) {
            CusotmerLabel.setForeground(Color.RED);
            return;
        }
        ...
        String query = "UPDATE CustomerAccount\n"
                ...
                + "Valued = " + ((Boolean)(ValuedDropDown.getSelectedIndex() == 0)).toString() + ",\n"
                + "DiscountPlan = " + (SelectedDiscount == null ? "NULL" : SelectedDiscount.getId().toString()) + "\n"
                + "WHERE No = " + SelectedCustomer.getId().toString();
    ...
    private void CustomerButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CustomerButtonMouseClicked
        CusotmerLabel.setForeground(Color.BLACK);
    ...
    private void DiscountButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DiscountButtonMouseClicked
        SelectionPopUpCaller SPUC = new SelectionPopUpCaller();
        SPUC.addSelectionListener(new SelectionListener() {
            @Override
            void selectionMade(Object Selection) {
                SelectedDiscount((Discount)Selection);
            }
        });
        AddJobPopUp.SelectMode = "DISCOUNTPLAN";
        AddJobPopUp obj = new
        AddJobPopUp(SPUC);
        obj.setVisible(true);
    }//GEN-LAST:event_DiscountButtonMouseClicked
    ...
    private javax.swing.JLabel CusotmerLabel;
    ...
    private javax.swing.JComboBox ValuedDropDown;
